...
class GlobalResult(NamedTuple):
    ...
    best_measurements: List[dict]
    best_optimized_parameters: Dict[str, List[float]]
    ...
    def __eq__(self, other) -> bool:
        return (
            ...
            and self.success_probability == other.success_probability
            and self.mutual_information == other.mutual_information
            and self.number_modes == other.number_modes
            and self.time_in_seconds == other.time_in_seconds
            and self.distance_to_helstrom_probability == other.distance_to_helstrom_probability
            and self.bit_error_rate == other.bit_error_rate
            and self.squeezing == other.squeezing
            and self.number_ancillas == other.number_ancillas
            and self.helstrom_probability == other.helstrom_probability
            and self.homodyne_probability == other.homodyne_probability
            and self.best_success_probability == other.best_success_probability
            and self.best_helstrom_probability == other.best_helstrom_probability
            and self.best_homodyne_probability == other.best_homodyne_probability
            and self.best_codebook == other.best_codebook
            and self.best_measurements == other.best_measurements
            and self.best_optimized_parameters == other.best_optimized_parameters
        )
